...
var utils = {
  ...
  mergeKeyWithParent: function mergeKeyWithParent(object, property) {
    ...
    var newObject = _zepto.default.extend({}, object, object[property]);
   ...
   * @return {Object}
   */
  renameKeysWithLevels: function renameKeysWithLevels(object, prefix) {
    return Object.keys(object).reduce(function (acc, key) {
      var result = acc;
      if (key.startsWith(prefix)) {
        var newKey = key.substring(key.indexOf('lvl'));
   ...
   */
  replaceNullString: function replaceNullString(object) {
    return Object.keys(object).reduce(function (acc, key) {
      var result = acc;
  ...
  groupBy: function groupBy(collection, property) {
    var newCollection = {};
    _zepto.default.each(collection, function (index, item) {
   ...
   * @return {string}
   **/
  replaceHtmlTagsToHighlight: function replaceHtmlTagsToHighlight(str) {
    return str.replace(/<em>/g, '<span class="docs-searchbar-suggestion--highlight">').replace(/<\/em>/g, '</span>');
  },
  /*
  ...
  getSnippetedValue: function getSnippetedValue(object, property) {
    ...
    var snippet = this.replaceHtmlTagsToHighlight(object._formatted[property]);
